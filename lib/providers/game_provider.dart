...
// gameover listener - check if the game is over and show the game over dialog
  ...
  int get gameCreatorChips => _gameCreatorChips;
  String get userId => _userId;
  String get userName => _userName;
  String get userPhoto => _userPhoto;
  int get userRating => _userRating;
  int get userChips => _userChips;
  ...
  void joinGame({
    ...
    try {
      ...
      _gameCreatorChips = game[Constants.gameCreatorChips];
      ...
      await firebaseFirestore
        ...
        Constants.gameCreatorChips.toString(): gameCreatorChips,
