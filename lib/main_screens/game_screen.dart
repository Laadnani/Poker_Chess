  ...
  void _onMove(Move move) async {
    ...
    if (gameProvider.vsComputer) {
      if (gameProvider.state.state == PlayState.theirTurn &&
        ...
        // Set the skill level (assuming the skill level is 2)
        //stockfish.stdin = 'setoption  SkillLevel 10';
        ...
        stockfish.stdin =
            ...
            '${UCICommands.goMoveTime} ${gameProvider.gameLevel * 2000} ${UCIOptinos.UCI_LimitStrength}';

        stockfish.stdin = 'setoption name MultiPV value 25';
